# Orquestador para Suples.cl Part1 y Part2 (paralelo total)
...
PART1_SCRIPT = os.path.join(SCRAPERS_DIR, "SuplesScraperPart1.py")
PART2_SCRIPT = os.path.join(SCRAPERS_DIR, "SuplesScraperPart2.py")
...
def main():
    ...
    console.print(Panel(
        f"[bold green]SuplesScraperRunner[/bold green]\n"
