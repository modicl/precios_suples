# Scraper para SportNutriShop.cl (Parte 2 de 3)
# Categorias: Pre Entrenos, Creatinas, Aminoacidos y BCAA, Perdida de Grasa
...
class SportNutriShopScraperPart2(BaseScraper):
    def __init__(self, headless=False):

        # Parte 2: Pre Entrenos, Creatinas, Aminoacidos, Perdida de Grasa
        category_urls = {
            "Pre Entrenos": [
                {
    ...
    def extract_process(self, page: Page):
        print(f"[green]Iniciando scraping SportNutriShop Parte 2/3 (PreEntrenos, Creatinas, Aminoacidos, Quemadores)...[/green]")
...
if __name__ == "__main__":
    scraper = SportNutriShopScraperPart2(headless=True)
    scraper.run()
