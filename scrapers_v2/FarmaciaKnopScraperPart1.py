# Scraper para FarmaciaKnopp (Parte 1 de 2)
# Categorias: Proteinas, Packs
...
class FarmaciaKnopScraperPart1(BaseScraper):
    ...
    def extract_process(self, page):
        print(f"[green]Iniciando scraping de {len(self.category_urls)} categorías en Farmacia Knopp (Part1)...[/green]")
...
if __name__ == "__main__":
    ...
    FarmaciaKnopScraperPart1(headless=args.headless).run()
