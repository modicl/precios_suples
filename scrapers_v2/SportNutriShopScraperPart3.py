# Scraper para SportNutriShop.cl (Parte 3 de 3)
# Categorias: Bebidas Nutricionales, Snacks y Comida, Vitaminas y Minerales, Packs
...
class SportNutriShopScraperPart3(BaseScraper):
    def __init__(self, headless=False):

        # Parte 3: Bebidas, Snacks, Vitaminas, Packs
        category_urls = {
    ...
    def extract_process(self, page: Page):
        print(f"[green]Iniciando scraping SportNutriShop Parte 3/3 (Bebidas, Snacks, Vitaminas, Packs)...[/green]")
...
if __name__ == "__main__":
    scraper = SportNutriShopScraperPart3(headless=True)
    scraper.run()
