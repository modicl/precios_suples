# Scraper para AllNutrition.cl (Parte 2 de 2)
# Categorias: Vitaminas, Pre Entrenos, Aminoacidos, Perdida de Grasa, Post Entreno, Snacks
...
class AllNutritionScraperPart2(BaseScraper):
    def __init__(self, headless=False):
        ...
        super().__init__("https://allnutrition.cl", headless, self.category_urls, selectors,
                         site_name="AllNutrition", output_suffix="_part2")
    ...
    def extract_process(self, page):
        print(f"[green]Iniciando scraping AllNutrition Parte 2/2 (Vitaminas, PreEntrenos, Aminoacidos, Quemadores, Snacks)...[/green]")
...
if __name__ == "__main__":
    scraper = AllNutritionScraperPart2(headless=True)
    scraper.run()
