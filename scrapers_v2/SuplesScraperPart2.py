# Scraper para Suples.cl (Parte 2 de 2)
# Categorias: Vitaminas y Minerales, Perdida de Grasa, Snacks y Comida, OTROS
...
class SuplesScraperPart2(BaseScraper):
    ...
    def extract_process(self, page):
        print(f"[green]Iniciando scraping Suples.cl Parte 2/2 (Vitaminas, Quemadores, Snacks, OTROS)...[/green]")
...
if __name__ == "__main__":
    scraper = SuplesScraperPart2(headless=True)
    scraper.run()
