# Orquestador para AllNutrition Part1 y Part2 (paralelo total)
...
PART1_SCRIPT = os.path.join(SCRAPERS_DIR, "AllNutritionScraperPart1.py")
PART2_SCRIPT = os.path.join(SCRAPERS_DIR, "AllNutritionScraperPart2.py")
...
def main():
    ...
    console.print(Panel(
        f"[bold green]AllNutritionScraperRunner[/bold green]\n"
