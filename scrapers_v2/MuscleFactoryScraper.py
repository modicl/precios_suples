...
class MuscleFactoryScraper(BaseScraper):
    ...
    def _classify_product(self, title, description, main_category, deterministic_subcategory, brand):
        """
        Clasificación de productos para MuscleFactory.
        Usa CategoryClassifier como base y aplica lógica extra específica de MuscleFactory.
        """
        title_lower = normalize(title.lower())
        text = title_lower + " " + normalize((description or "").lower())

        # ── Lógica extra MuscleFactory: Snacks especiales en Proteínas ───────────
        ...
        # ── Lógica extra MuscleFactory: Creatina Greatlhete Crea Pro ──────────
        ...
        # ── Post-clasificación MuscleFactory: overrides específicos de proteínas ──
