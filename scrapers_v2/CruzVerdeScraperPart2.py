# Scraper para Cruz Verde (Parte 2 de 2)
# Categorias: Energia, Bebidas Nutricionales
...
class CruzVerdeScraperPart2(BaseScraper):
    def __init__(self, headless=False):
        self.category_urls = {
            "Energia": [
                {"url": "https://www.cruzverde.cl/vitaminas-y-suplementos/nutricion-deportiva/energia-y-resistencia/", "subcategory": "Energia"},
            ],
            "Bebidas Nutricionales": [
                {"url": "https://www.cruzverde.cl/vitaminas-y-suplementos/nutricion-deportiva/hidratacion/", "subcategory": "Isotónicas"},
            ],
        }
    ...
    def extract_process(self, page):
        print(f"[green]Iniciando scraping de Cruz Verde (Part2: Energia + Bebidas)...[/green]")
...
if __name__ == "__main__":
    ...
    CruzVerdeScraperPart2(headless=args.headless).run()
