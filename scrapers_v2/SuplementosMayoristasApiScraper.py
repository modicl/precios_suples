"""
SuplementosMayoristasApiScraper.py
===================================
Scraper para SuplementosMayoristas vía VTEX Catalog API (sin Playwright).
~10x más rápido que el scraper browser tradicional.

Categorías validadas contra la API en test_vtex_api.py.

Uso:
    python SuplementosMayoristasApiScraper.py
    python SuplementosMayoristasApiScraper.py --headless   # ignorado, compat con RunAll
"""
...
CATEGORIES = [
    ("Proteinas",          "Proteína de Whey",            "C:/1/13/"),
    ("Proteinas",          "Proteína Aislada",             "C:/1/12/"),
    ("Proteinas",          "Proteína Hidrolizada",         "C:/1/14/"),
    ("Proteinas",          "Proteína Aislada",             "C:/1/15/"),   # Clear Whey
    ("Proteinas",          "Proteína Vegana",              "C:/1/16/"),
    ("Proteinas",          "Proteína de Carne",            "C:/1/9288/"),
...
class SuplementosMayoristasApiScraper(BaseScraper):
    def __init__(self):
        super().__init__(
        ...
        self.subfolder = "suplementosmayoristas"
    ...
    def extract_process(self, page):
        raise NotImplementedError("SuplementosMayoristasApiScraper usa run() directo, no Playwright.")
...
if __name__ == "__main__":
    ...
    parser.parse_args()
    SuplementosMayoristasApiScraper().run()
