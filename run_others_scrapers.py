...
def run_scrapers():
    ...
    processes = []
    print(f"--- Iniciando {len(scrapers)} scrapers rápidos en paralelo ---")
    ...
    print(f"\n--- Todos los scrapers rápidos han finalizado en {duration:.2f} segundos ---")

    print("\n--- Ejecución Completa (Sin Post-Procesamiento) ---")
